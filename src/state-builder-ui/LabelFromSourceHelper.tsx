...
export function LabelFromSourceHelper({ node, onUpdate, open, onOpenChange, trigger }: LabelFromSourceHelperProps) {
        ...
        content: (
          <div className='flex flex-col gap-3'>
            ...
            <div className='flex flex-col gap-1'>
              ...
              <Input className='h-7 text-xs font-mono' placeholder='label' value={fieldName} onChange={(e) => setFieldName(e.target.value)} />
            </div>
