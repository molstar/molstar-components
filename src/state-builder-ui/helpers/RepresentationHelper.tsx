...
interface RepresentationHelperProps {
  node: UINode;
...
export function RepresentationHelper({ node, onUpdate, open, onOpenChange, trigger, onCustomChange }: RepresentationHelperProps) {
  ...
  const types = getActiveValues(REPRESENTATION_TYPES);
  return (
